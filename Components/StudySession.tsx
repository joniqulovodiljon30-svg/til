...
import { evaluateAnswer } from '../services/proAiService';
        ...
        <div className="w-full max-w-2xl">
          ...
          {mode === 'STUDY' && (
            <div 
              ...
              className="bg-white rounded-2xl shadow-xl border border-gray-200 min-h-[400px] flex flex-col items-center justify-center text-center p-10 cursor-pointer hover:border-indigo-400 transition-all select-none"
            >
              {studySide === 'FRONT' ? (
                <div className="animate-in fade-in zoom-in-95 duration-300">
                  <h1 className="text-5xl md:text-7xl font-black text-slate-900 mb-6 tracking-tighter">{currentCard.word}</h1>
                  <p className="text-xl md:text-2xl font-serif italic text-slate-400">{currentCard.ipa}</p>
                  <p className="mt-12 text-[10px] font-black uppercase tracking-[0.2em] text-indigo-500">Tap to Flip</p>
                </div>
              ) : (
